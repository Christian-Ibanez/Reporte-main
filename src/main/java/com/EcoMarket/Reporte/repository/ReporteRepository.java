     ...
     public Reporte generarReporteVenta(int id) {
        for (Reporte reporte : Reporte) {
            if (reporte.getId() == id && reporte.getTipo() == TipoReporte.VENTAS) {
                System.out.println("Generando reporte de venta en formato " + reporte.getFormato() + " para la fecha " + reporte.getFecha());
                return reporte;
            }
        }
     ...
     public Reporte generarReporteInventario(int id) {
        for (Reporte reporte : Reporte) {
            if (reporte.getId() == id && reporte.getTipo() == TipoReporte.INVENTARIO) {
                System.out.println("Generando reporte de inventario en formato " + reporte.getFormato() + " para la fecha " + reporte.getFecha());
                return reporte;
            }
        }
